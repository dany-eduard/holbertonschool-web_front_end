...
Based on [Tenon.io](https://tenon.io/ "Tenon.io") insights, around 49% of tests are automated (using Axe, Lighthouse etc) and 55% are manual (Screen readers, code analysis etc).
